...
<link rel="stylesheet" type="text/css" href="css/productlist.css"/>
	...
	<body >
	<form action="AProductServlet" method="post">
		<div class="productlist">
			<div class="listhead">添加商品</div>
			<div class="listdown">
				...
				<div class="listdown-right" id="listdown-right-id">
					<div id="right-id0"><input type='text' name="pname"/><span>*</span></div>
					<div id="right-id1"><select id="sys" name="sel1"><option>1</option></select>
										<select id="sub" name="sel2"><option>2</option></select></div>
					<div id="right-id2"><input type='text'/ name="pno"><span>*</span></div>
